...
use aptos_types::{
    ...
    transaction::{
        ...
        TransactionArgument, TransactionExecutable,
        TransactionExtraConfig, TransactionOutput, TransactionPayload, TransactionPayloadV2, TransactionStatus, VMValidatorResult,
...
impl AptosVM {
    ...
    fn execute_or_simulate_multisig_transaction<'a, 'r, 'l>(
        ...
        traversal_context: &mut TraversalContext<'a>,
        txn_data: &TransactionMetadata,
        // TODO: Is it okay to pass executable and multisig_address as separate arguments here?
        executable: &'a TransactionExecutable,
        multisig_address: AccountAddress,
        log_context: &AdapterLogSchema,
        new_published_modules_loaded: &mut bool,
